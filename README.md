...
![Godot Toolbox Project](/assets/logo/logo256.png "Godot Toolbox Project")
...
Changing the looks is easy, just modify this [theming atlas](/assets/theme.png).
...
![GameOver dialog](/readme/screenshot_game3.png "GameOver dialog")
...
![Mobile controls](/readme/screenshot_game4.png "Mobile controls")
...
![Mobile joystick configuration](/readme/screenshot_mobilecontrols.png "Mobile joystick configuration")

## ![](/assets/logo/logo32.png "") Settings

![Settings screen](/readme/screenshot_settings.png "Settings screen")

Video, audio and controls settings can all be adjusted and are saved using the PersistenceMngr.

### Controls

![Controls screen](/readme/screenshot_controls.png "Controls screen")
...
## ![](/assets/logo/logo32.png "") Demo Levels
...
![TopDown with a 3x3 autotile tileset](/readme/screenshot_game2.png "TopDown with a 3x3 autotile tileset")
...
![Platformer with parallax and enemy](/readme/screenshot_game1.png "Platformer with parallax and enemy")
...
Debug.log("Player", ["grounded", position])

# equivalent
Debug.log(Debug.LogCategory.GAME, ["Savefile could not be found", state], LogLevel.WARN)
Debug.warning(Debug.LogCategory.GAME, ["Savefile could not be found", state])
```
